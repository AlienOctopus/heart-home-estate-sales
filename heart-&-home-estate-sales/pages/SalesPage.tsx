...
// Sales showcase page - the beautiful editorial presentation
// This is where the current sale lives + shopper info
...
export const SalesPage: React.FC = () => {
    ...
    return (
        <div className="bg-cream min-h-screen text-olive font-body">
            ...
            {/* Breadcrumb / Context */}
            <div className="pt-28 pb-4 px-6 md:px-12 max-w-[1600px] mx-auto">
            ...
            <section className="pb-20 px-6 md:px-12 relative overflow-hidden">
                ...
                <div className="max-w-[1600px] mx-auto w-full relative z-10 grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    {/* Typography Layer */}
                    <div className="lg:col-span-6 lg:order-1 relative z-20">
                        <div
                        ...
                        >
                            ...
                            <span className="font-mono text-xs font-bold tracking-widest uppercase text-olive">Upcoming Sale • {DATA.sale.dates[0].date}</span>
                        </div>

                        {/* Massive Display Type */}
                        <h1
                            className={`font-display text-[12vw] lg:text-[9rem] font-medium text-olive leading-none tracking-tighter mb-8 -ml-2 lg:-mr-32 relative z-30 transition-all duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)] delay-100 ${
                                loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                            }`}
                        >
                            {DATA.sale.name.split(' ').slice(0, -1).join(' ')}<br/>
                            <span className="italic text-sage/90 relative inline-block font-light">
                                {DATA.sale.name.split(' ').slice(-1)}
                            </span>
                        </h1>
